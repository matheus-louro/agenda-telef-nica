...
//  int main()
//  {
//      // teste funcao nome_valido
//      char nome[30] = "matheus";
//      if (nome_valido(nome))
//          printf("nome valido\n");
//      else
//          printf("nome invalido\n");

//     // teste funcao telefone_valido
//     char telefone[] = "65996003979";
//     if (telefone_valido(telefone))
//         printf("telefone valido\n");
//     else
//         printf("telefone invalido\n");

//     // teste funcao email_valido
...
//     // teste funcao data_valida
//     if (data_valida("07/06/2002"))
//         printf("data valida\n");
//     else
